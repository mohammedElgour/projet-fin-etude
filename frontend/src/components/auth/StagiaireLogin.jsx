  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data?.user?.role !== 'stagiaire') {
        const message = 'This account does not have student access.';
        setError(message);
      ...
      toast.success('Login successful.', `Welcome back, ${data?.user?.name || 'Student'}.`);
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-50 via-white to-primary-50 px-4 py-12 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 sm:px-6 lg:px-8">
      ...
      >
        ...
        <h2 className="mb-6 text-center text-3xl font-bold text-slate-900 dark:text-white">Stagiaire</h2>
